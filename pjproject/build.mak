export PJDIR := /Users/mohammadsulaiman/Desktop/TalkPort/pjproject
...
export TARGET_ARCH := 
export STD_CPP_LIB := 
export TARGET_NAME := aarch64-apple-darwin25.2.0
...
export APP_CFLAGS := -DPJ_AUTOCONF=1\
        -arch arm64 -O2 -DNDEBUG -DPJ_IS_BIG_ENDIAN=0 -DPJ_IS_LITTLE_ENDIAN=1\
        $(PJ_VIDEO_CFLAGS) \
...
export APP_CXXFLAGS := -arch arm64 -O2 -DNDEBUG $(APP_CFLAGS)
...
export APP_LDLIBS := $(PJSUA_LIB_LDLIB) \
        ...
        $(APP_THIRD_PARTY_EXT)\
        $(PJLIB_LDLIB) \
        -lm -lpthread  -framework CoreAudio -framework CoreServices -framework AudioUnit -framework AudioToolbox -framework Foundation -framework AppKit
...
export PJ_INSTALL_LDFLAGS_PRIVATE := $(APP_THIRD_PARTY_LIBS) $(APP_THIRD_PARTY_EXT) -lm -lpthread  -framework CoreAudio -framework CoreServices -framework AudioUnit -framework AudioToolbox -framework Foundation -framework AppKit
